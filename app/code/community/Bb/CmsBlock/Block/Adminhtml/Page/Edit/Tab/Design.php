 ...
 */
class Bb_CmsBlock_Block_Adminhtml_Page_Edit_Tab_Design
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $layoutFieldset->addField('root_template-checkbox', 'checkbox', array(
            'name'     => 'root_template-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
        ...
        $layoutFieldset->addField('layout_update_xml-checkbox', 'checkbox', array(
            'name'     => 'layout_update_xml-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
        ...
        $designFieldset->addField('custom_theme_from-checkbox', 'checkbox', array(
            'name'     => 'custom_theme_from-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
        ...
        $designFieldset->addField('custom_theme_to-checkbox', 'checkbox', array(
            'name'     => 'custom_theme_to-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
        ...
        $designFieldset->addField('custom_theme-checkbox', 'checkbox', array(
            'name'     => 'custom_theme-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
        ...
        $designFieldset->addField('custom_root_template-checkbox', 'checkbox', array(
            'name'     => 'custom_root_template-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
        ...
        $designFieldset->addField('custom_layout_update_xml-checkbox', 'checkbox', array(
            'name'     => 'custom_layout_update_xml-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
