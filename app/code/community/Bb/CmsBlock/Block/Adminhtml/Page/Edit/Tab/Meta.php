 ...
 */
class Bb_CmsBlock_Block_Adminhtml_Page_Edit_Tab_Meta
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('meta_keywords-checkbox', 'checkbox', array(
            'name'     => 'meta_keywords-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
        ...
        $fieldset->addField('meta_description-checkbox', 'checkbox', array(
            'name'     => 'meta_description-checkbox',
            'label'    => '',
            'title'    => '',
            'value'    =>  1,
            'after_element_html' => Mage::helper('cms')->__('Change'),
